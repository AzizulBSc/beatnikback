...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">New Vehicle Registration</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-lg-12">
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title">Vehicle <small>Registration</small></h3>
                    </div>
                                ...
                                <form action="{{ url('vehicle') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="number" name="model_year" class="form-control"
                                                    placeholder="Enter Your Vehicle Model Year" value="" required>
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-4"><label for="engin_num">Engine Number</label>
                                                <input name="engin_num" type="text" class="form-control"
                                                    placeholder="Enter Engine Number" value="">
                                            </div>
                                            <div class="col-4">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <input name="chasis_num" type="text" class="form-control"
                                                    placeholder="Enter Chasis Number" value="">
                                            </div>
                                        ...
                                        <div class="form-group col-lg-8">
                                            ...
                                            <!-- Dropdown -->
                                            <select name="customer_id" id="owner" class="form-control" type="number" required>
