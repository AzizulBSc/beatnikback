                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="card-title">Add Vehicle Categroy</h3>
                            <a href="{{ url('/vehicleCat') }}" class="btn btn-primary">Go Back to Vehicle Categroy
                                List</a>
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-12 col-lg-8 offset-lg-2 col-md-8 offset-md-2">
                                <form action="{{ url('/vehicleCat') }}" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="category" value="" class="form-control"
                                                placeholder="Enter category like (3 Whillers,8 Whillers)" required>
                                        </div>
                                        <div class="form-group">
