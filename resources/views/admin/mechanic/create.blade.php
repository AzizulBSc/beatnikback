        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('service') }}">Service list</a></li>
            ...
            <div class="col-lg-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Mechanic <small>Registration</small></h3>
                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="salary" value="" class="form-control"
                                                placeholder="Enter Sallary" required>
